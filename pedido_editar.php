...
?>
    ...
    <form action="salvar_pedido_editar.php" method="POST">
        <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Incluir Pedido</h4>
                            ...
                            <div class="card-body table-responsive p-0">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $select_cliente = ("SELECT cliente FROM `pedidos_realizados` where `status_pedido` = '1' and `id_pedido` = $pedido group by `cliente` ");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <div style="width: 100px" class="btn-group">
                                                        ...
                                                        <input class="btn btn-block bg-gradient-default btn-xs" name="pecadetalhe[<?= $index ?>][qtde]" min="0" name="quantity" value="0" type="number">
