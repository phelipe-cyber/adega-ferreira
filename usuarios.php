        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Novo login</h4>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <input name="login"  type="login" class="form-control" id="exampleInputEmail1" placeholder="Enter login" required >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input  name="senha"  value="adega123" type="senha" class="form-control" id="exampleInputPassword1" placeholder="Senha">
                  </div>
...
<div class="card-body">
    <div class="card-deck">
        <div class="card mb-4">
            ...
            <tbody>
                <?php
                $result_usuarios = ("SELECT * FROM `user`");
                ...
                ?>
                    <tr style="text-align:center">
                        ...
                        <td>
                            <?php echo $row_usuario['user']?>
                        </td>
                        <td>
                            <?php echo $row_usuario['e-mail']?>
                        </td>
                        <td>
