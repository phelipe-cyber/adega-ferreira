                            ...
                            <div class="card card-primary">
                                            ...
                                            ?>
                                                <div class="card-body table-responsive p-0 text-center ">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        <?php
                                                        $recebidos2 = ("SELECT SUM(valor_pedido * total_pedido) as 'Total Pedido' FROM `pedidos_realizados` where `created_date` BETWEEN '$datahoje 00:00:00' AND '$datahoje 23:59:59' ");
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $recebidos2 = ("SELECT *, SUM(valor_pedido * total_pedido) as 'Total Pedido' , SUM(total_pedido) as 'Total Descricao' FROM `pedidos_realizados` where `created_date` BETWEEN '$datahoje 00:00:00' AND '$datahoje 23:59:59' GROUP BY descricao_pedido ORDER BY `Total Descricao` DESC  ");
                                                            $recebidos3 = mysqli_query($conexao, $recebidos2);
                                                            $index = "1";
                                                            while ($row = mysqli_fetch_assoc($recebidos3)) {
                                ...
                                ?>
                                    ...
                                    <div class="card-body table-responsive p-0 text-center ">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <?php
                                                $recebidos2 = ("SELECT SUM(valor_pedido * total_pedido) as 'Total Pedido' FROM `pedidos_realizados` where `created_date` BETWEEN '$Datainicio 00:00:00' AND '$Datafinal 23:59:59' ");
                                            ...
                                            <tbody>
                                                ...
                                                $recebidos2 = ("SELECT *, SUM(valor_pedido * total_pedido) as 'Total Pedido' , SUM(total_pedido) as 'Total Descricao' FROM `pedidos_realizados` where `created_date` BETWEEN '$Datainicio 00:00:00' AND '$Datafinal 23:59:59' GROUP BY descricao_pedido ORDER BY `Total Descricao` DESC ");
